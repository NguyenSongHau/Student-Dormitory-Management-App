...
const Chat = ({ navigation, route }) => {
   ...
   const onSend = useCallback((messages = []) => {
      ...
      addDoc(collection(firestore, 'chats'), {
         ...
         toUser: {
            ...
            fullName: toUser?.full_name || toUser?.fullName,
   ...
   return (
      <ImageBackground source={require('../../Assets/Images/Images/ChatBackground.jpg')} style={{ flex: 1 }}>
         <View style={{ flex: 1 }} onTouchStart={() => Keyboard.dismiss()}>
            <GiftedChat
               ...
               user={{
                  ...
                  fullName: currentAccount.data.full_name,
